...
<script>
	$(function(){
		...
		$('#btnAdd').click(function(){
			...
			$('#myForm').attr('action', '<?php echo site_url('employee/addEmployee'); ?>');
		});
		...
		$('#showdata').on('click', '.item-edit', function(){
			...
			$('#myForm').attr('action', '<?php echo site_url('employee/updateEmployee'); ?>');
			$.ajax({
				type: 'ajax',
				method: 'get',
				url: '<?php echo site_url('employee/editEmployee') ?>',
				data: {id: id},
				async: false,
				dataType: 'json',
		...
		function showAllEmployee(){
			$.ajax({
				type: 'ajax',
				url: '<?php echo site_url('employee/showAllEmployee'); ?>',
				async: false,
				dataType: 'json',
				success: function(data){
					var html = '';
